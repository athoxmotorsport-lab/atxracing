...
def page(lang,game,section):
 ...
 footer=f'<footer class="footer"><div class="wrap"><span>© 2026 ATXRACING</span><span><a href="https://discord.com/invite/dgyJJYTSsD">Discord</a> · <a href="https://www.thesimgrid.com/communities/atxracing">SimGrid</a> · <a href="/{lang}/{game}/privacy.html">{escape(t["privacy"])}</a></span></div></footer>'
 if section=='home':
  ...
  if section=='league':
   ...
   elif game=='ace': main+=f'<section class="status-panel"><span class="eyebrow">ACE / {escape(v["published"])}</span><h2>{escape(v["league_ace"])}</h2><p>{escape(v["ace_pending"])}</p><a class="pill" href="/{lang}/acc/">{escape(v["back_acc"])} ↗</a></section>'
   else:
    if section=='courses':
